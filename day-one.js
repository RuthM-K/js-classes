 ...
 * strict equality operator (===)- compares both the values and the datatypes(checks if they are equal)
 * strict inequality operator(!==)- checks if the values and the datatypes are not equal
 * loose equality operator(==)- compares the values ONLY(does not compare the data types)
 * loose inequality operator(!=)- opposite of (==)
 */
console.log(45 === '45')
 ...
 * double band operator (!!)- converts a value to a boolean 
 * AND (&&)
 * OR (||)-double pipe
 */
console.log(!false)
